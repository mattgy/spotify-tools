#!/usr/bin/env python3
"""
Script to reset the virtual environment for Matt Y's Spotify Tools.
This script is designed to be run directly from the system Python,
not from within the virtual environment.
